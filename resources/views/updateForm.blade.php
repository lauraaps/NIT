...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
   <div class="container-fluid">
      <a class="navbar-brand" href="{{ route('AboutUsPage') }}?api_token={{ $api_token }}" alt="logo"> 
         <img src="{{asset('Carrer Training School.png')}}" alt="logo" class="LogoSize">
      </a>
...
<div class="mb-3">
    ...
    <input value="{{$user->first_name}}" name ="first_name" type="text" class="form-control" id="exampleInputFirstName">
</div>
<div class="mb-3">
    <label for="exampleInputLastName" class="form-label">Last Name</label>
    <input value="{{$user->last_name}}" name ="last_name" type="text" class="form-control" id="exampleInputLastName">
</div>
<div class="mb-3">
    <label for="exampleInputAge" class="form-label">Age</label>
    <input value="{{$user->age}}" name ="age" type="number" class="form-control" id="exampleInputAge">
</div>
<div class="mb-3">
    <label for="exampleInputPhone" class="form-label">Phone</label>
    <input value="{{$user->phone}}" name = "phone" type="phone" class="form-control" id="exampleInputPhone">
</div>
<div class="mb-3">
    <label for="exampleInputAddress" class="form-label">Address</label>
    <input value="{{$user->address}}" name="address" type="address" class="form-control" id="exampleInputAddress">
</div>
<div class="mb-3">
    <label for="exampleInputProfessionalSummary" class="form-label">Professional Summary</label>
    <textarea name="professional_summary" class="form-control" id="exampleInputProfessionalSummary" rows="4">{{$user->summary}}</textarea>
</div>
<div class="mb-3">
  ...
  <div class="card">
    <div class="card-body">
      <div class="logo-position">
       <h5 class="card-title"><img src="{{asset('Carrer Training School.png')}}" class="LogoSize"></h5>
       </div>
